...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btnDaftar,btnBracket,btnBracketTeam;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBracketTeam=findViewById(R.id.btnBracketTeam);

        btnBracketTeam.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, BracketTeamActivity.class);
